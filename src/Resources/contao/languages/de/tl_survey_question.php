...
$GLOBALS['TL_LANG']['tl_survey_question']['name'] = ['Alias', 'Ein eindeutiger Bezeichner, der im Export und zur Definition von Abhängigkeiten benutzt wird.'];
...
$GLOBALS['TL_LANG']['tl_survey_question']['rating_range'] = ['Bewertungs-Bereich', 'Legen Sie die maximale Anzahl an Punkten fest, die vergeben werden können.'];
